...
int main(){
	...
	if(init_led(LED_gpioB, LED1_pin) != 0 || init_led(LED_gpioB, LED2_pin) != 0 || init_led(LED_gpioB, LED3_pin) != 0 || init_led(LED_gpioB, LED4_pin) != 0|| init_button(BUTTON_gpio, BUTTON_pin) != 0){
	...
	const gpio cs_[4] = {{GPIOB},{GPIOB},{GPIOB},{GPIOB}};//struct
